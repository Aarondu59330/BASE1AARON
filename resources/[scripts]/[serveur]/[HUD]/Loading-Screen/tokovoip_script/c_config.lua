TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "╘» Generation-V • InGame",
		TSPassword = "gene88_gt3", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "╒» Generation-V • Warteraum",

		-- Blocking screen informations
		TSServer = "Generation-V", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "╒» Wartezimmer • Support", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://forums.rmog.us", -- Download link displayed on blocking screen
		TSChannelWhitelist = { -- Black screen will not be displayed when users are in those TS channels
		"╒» Projektleitung • Felix.",
		"╞» Felix. • Büro",
		"╞» Felix. • do not disturb!",
		"╒» Projektleitung • Jan",
		"╞» Jan • Büro",
		"╞» Jan • do not disturb!",
		"╒» Management • Constantin",
		"╞» Management • Büro",
		"╘» Management • do not disturb!",
		"╒» Communitymanagement",
		"╞» Communitymanagement • Büro",
		"╘» Communitymanagement • do not disturb!",
		"╒» Lead Development",
		"╞» Lead Development • Büro",
		"╘» Lead Development • do not disturb!",
		"╒ Bearbeitung • I",
		"╞ Bearbeitung • II",
		"╞ Bearbeitung • III",
		"╞ Bearbeitung • IV",
