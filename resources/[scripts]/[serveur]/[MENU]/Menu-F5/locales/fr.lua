Locales['fr'] = {
  ...
  -- Main Menu
  ['mainmenu_subtitle'] = '~b~REMPLACE MOI',
  ['mainmenu_gps_button'] = '~b~GPS',
  ['mainmenu_approach_button'] = '~b~Démarche',
  ['mainmenu_voice_button'] = '~b~Voix',
  ['gps'] = '~b~ GPS: ~b~%s',
  ['approach'] = '~b~ Démarche: ~b~%s',
  ['voice'] = '~b~Voix: ~b~%s',
  ...
  ['wallet_job2_button'] = '~b~Organisation:~w~ %s - %s',
  ...
  ['bossmanagement2_title'] = '~b~Gestion Organisation: %s',
